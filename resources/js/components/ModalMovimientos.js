    ...
    <>
      <section className="modal-custom shadow"> 
        ...
        <div className="modal-content">
          <h4 className="text-center">Devoluciones / Garantías  <button className="btn btn-sinapsis mb-3 pull-right" onClick={setDevolucion} disabled={(clienteselectdevolucion&&productosselectdevolucion.length)?false:true}>Guardar{clienteselectdevolucion?(productosselectdevolucion.length?true:(" (Debe agregar un producto)")):" (Debe agregar un cliente)"}</button> {devolucionselect?"#".devolucionselect:null}</h4>
                      ...
                      <tbody>
                        {productosDevolucionSelect.length?productosDevolucionSelect.map(e=>
                          <tr key={e.id} data-id={e.id} className="pointer">
                            ...
                            <td>P/U. {e.precio}</td>
                            <th>
                              <button className="btn btn-circle text-white btn-success btn-sm me-1" data-id={e.id} data-tipo={1} data-precio={e.precio} onClick={sethandleproductosselectdevolucion} title="Entrada" ><i className="fa fa-arrow-down"></i></button>
                              <button className="btn btn-circle text-white btn-danger btn-sm me-1" data-id={e.id} data-tipo={0} data-precio={e.precio} onClick={sethandleproductosselectdevolucion} title="Salida"><i className="fa fa-arrow-up"></i></button>
                            </th>
                          </tr>
                        ):null}
                      </tbody>

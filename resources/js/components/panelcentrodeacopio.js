                    ...
                    {selectSucursalCentral!==null?
                        <>
                            <div className="btn-group">
                                ...
                                <button className="btn btn-outline-success mb-1" onClick={()=>setsubviewpanelcentroacopio("estadisticaspanelcentroacopio")}>Estadísticas</button>
                                ...
                                <button className="btn btn-outline-success mb-1" onClick={()=>setsubviewpanelcentroacopio("diadeventapanelcentroacopio")}>Día de Venta</button>
